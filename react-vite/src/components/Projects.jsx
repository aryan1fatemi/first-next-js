...
const Projects = () => {
  ...
  return (
    ...
    <div id="Projects" class="p-20 flex flex-col items-center justify-center place-content-between">
      ...
      {showAbout && <AboutProject onClose={handleCloseAbout} Title="Cart Pole enviroment" Body="h"/>}
      <div class="grid lg:grid-cols-3 md:grid-cols-2 grid-cols-1 justify-around gap-10">
          ...
          <div  data-aos="fade-up" className="justify-items-center border-2 border-indigo-600 px-2 py-5 rounded-3xl aos-init aos-animate flex flex-col">
            ...
            <div className="flex flex-row place-content-around">
              ...
              <a href="https://amessenger-3r85.vercel.app/" target="_blank">
                <button data-aos="fade-up" className="neno-button shadow-xl hover:shadow-indigo-800/50 text-white border-2 hover:bg-indigo-600 border-indigo-500 rounded py-1 relative overflow-hidden px-5 mx-auto">About</button>
              </a>
            </div>
          </div>
          <div  data-aos="fade-up" className="justify-items-center border-2 border-indigo-600 px-2 py-5 rounded-3xl aos-init aos-animate flex flex-col">
            ...
            <div className="flex flex-row place-content-around">
              ...
              <div>
                ...
                <button data-aos="fade-up" className="neno-button shadow-xl hover:shadow-indigo-800/50 text-white border-2 hover:bg-indigo-600 border-indigo-500 rounded py-1 relative overflow-hidden px-5 mx-auto" onClick={handleShowAbout}>About</button>
